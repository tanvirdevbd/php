...
<body>
    ...
    <div class="d-flex justify-content-end">
        <!-- edit Modal start-->
        <div class="modal fade modal-lg" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel"
            aria-hidden="true">
        ...
        <div class="modal fade modal-lg" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel"
            aria-hidden="true">
                        ...
                        <div class='form-section'>
                            <form action='dashboard.php' method='POST' enctype="multipart/form-data">
                                ...
                                <div class='right'>
                                    ...
                                    <!-- address  -->
                                    <div class="mb-2">
                                        <textarea class="form-control me-2" id="address" name="address" rows="4"
        ...
        <!-- add Modal end-->
        <input type="text" id="search-info" name="search-info" class="my-2 p-2 me-3 search-dashboard"
