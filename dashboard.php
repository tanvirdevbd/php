...
<body>
    ...
    <div class="d-flex justify-content-end">
        <!-- edit Modal start-->
        <div class="modal modal-tall fade modal-xl" id="editUserModal" tabindex="-1"
        ...
        <div class="modal  modal-tall fade modal-xl" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel"
            aria-hidden="true">
